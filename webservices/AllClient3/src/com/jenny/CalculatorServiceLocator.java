...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.jenny.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://192.168.1.37:8091/SOAPWebServiceDemo/services/Calculator";
    ...
    public com.jenny.Calculator getCalculator() throws javax.xml.rpc.ServiceException {
    ...
    public com.jenny.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.jenny.CalculatorSoapBindingStub _stub = new com.jenny.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.jenny.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.jenny.CalculatorSoapBindingStub _stub = new com.jenny.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://jenny.com", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://jenny.com", "Calculator"));
        }
