...
public class CalculatorProxy implements com.jenny.Calculator {
  private String _endpoint = null;
  private com.jenny.Calculator calculator = null;
  ...
  private void _initCalculatorProxy() {
    try {
      calculator = (new com.jenny.CalculatorServiceLocator()).getCalculator();
      if (calculator != null) {
        if (_endpoint != null)
  ...
  public com.jenny.Calculator getCalculator() {
    if (calculator == null)
      _initCalculatorProxy();
    return calculator;
  }
